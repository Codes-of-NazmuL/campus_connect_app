...
class StudentChatsScreen extends ConsumerStatefulWidget {
  const StudentChatsScreen({super.key});

  @override
  ConsumerState<StudentChatsScreen> createState() => _StudentChatsScreenState();
}

class _StudentChatsScreenState extends ConsumerState<StudentChatsScreen> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            const Padding(
              ...
              child: SearchBarInput(hintText: 'Search chats...'),
            ),
            Expanded(
              child: isLoading
        ...
        floatingActionButton: FloatingActionButton(
          heroTag: 'student_chats_fab',
          onPressed: () async {
            await context.push('/chat/new');
            _loadRooms(); // reload after creating a new chat
          },
